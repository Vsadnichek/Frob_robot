...
static const _ObstacleDetection_type_support_symbol_names_t _ObstacleDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, frob_interfaces, msg, ObstacleDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, frob_interfaces, msg, ObstacleDetection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, frob_interfaces, msg, ObstacleDetection)() {
  return &::frob_interfaces::msg::rosidl_typesupport_c::ObstacleDetection_message_type_support_handle;
}
