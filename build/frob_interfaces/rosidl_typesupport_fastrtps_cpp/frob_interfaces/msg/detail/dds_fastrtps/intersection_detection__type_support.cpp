...
#include "frob_interfaces/msg/detail/intersection_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const frob_interfaces::msg::IntersectionDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  frob_interfaces::msg::IntersectionDetection & ros_message)
{
  // Member: junction_type
  cdr >> ros_message.junction_type;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_frob_interfaces
max_serialized_size_IntersectionDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = frob_interfaces::msg::IntersectionDetection;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_frob_interfaces
max_serialized_size_key_IntersectionDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const frob_interfaces::msg::IntersectionDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<frob_interfaces::msg::IntersectionDetection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _IntersectionDetection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const frob_interfaces::msg::IntersectionDetection *>(
...
static size_t _IntersectionDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IntersectionDetection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _IntersectionDetection__callbacks = {
  "frob_interfaces::msg",
...
static rosidl_message_type_support_t _IntersectionDetection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_IntersectionDetection__callbacks,
...
{
  return &frob_interfaces::msg::typesupport_fastrtps_cpp::_IntersectionDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frob_interfaces, msg, IntersectionDetection)() {
  return &frob_interfaces::msg::typesupport_fastrtps_cpp::_IntersectionDetection__handle;
}
