    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'frob_interfaces.action.ExecuteMotion_Goal')
            logger.debug(
...
class Metaclass_ExecuteMotion_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'frob_interfaces.action.ExecuteMotion_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ExecuteMotion_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'frob_interfaces.action.ExecuteMotion_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion_SendGoal_Request(metaclass=Metaclass_ExecuteMotion_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'frob_interfaces/ExecuteMotion_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['frob_interfaces', 'action'], 'ExecuteMotion_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from frob_interfaces.action._execute_motion import ExecuteMotion_Goal
...
class ExecuteMotion_SendGoal_Event(metaclass=Metaclass_ExecuteMotion_SendGoal_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<frob_interfaces/ExecuteMotion_SendGoal_Request, 1>',
        'response': 'sequence<frob_interfaces/ExecuteMotion_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['frob_interfaces', 'action'], 'ExecuteMotion_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['frob_interfaces', 'action'], 'ExecuteMotion_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from frob_interfaces.action import ExecuteMotion_SendGoal_Request
    ...
    def response(self, value):
        if self._check_fields:
            from frob_interfaces.action import ExecuteMotion_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_ExecuteMotion_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'frob_interfaces.action.ExecuteMotion_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from frob_interfaces.action import _execute_motion
...
class ExecuteMotion_SendGoal(metaclass=Metaclass_ExecuteMotion_SendGoal):
    from frob_interfaces.action._execute_motion import ExecuteMotion_SendGoal_Request as Request
    from frob_interfaces.action._execute_motion import ExecuteMotion_SendGoal_Response as Response
    from frob_interfaces.action._execute_motion import ExecuteMotion_SendGoal_Event as Event
...
class ExecuteMotion_GetResult_Response(metaclass=Metaclass_ExecuteMotion_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'frob_interfaces/ExecuteMotion_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['frob_interfaces', 'action'], 'ExecuteMotion_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from frob_interfaces.action._execute_motion import ExecuteMotion_Result
...
class ExecuteMotion_GetResult_Event(metaclass=Metaclass_ExecuteMotion_GetResult_Event):
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<frob_interfaces/ExecuteMotion_GetResult_Request, 1>',
        'response': 'sequence<frob_interfaces/ExecuteMotion_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['frob_interfaces', 'action'], 'ExecuteMotion_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['frob_interfaces', 'action'], 'ExecuteMotion_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from frob_interfaces.action import ExecuteMotion_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
    ...
    def response(self, value):
        if self._check_fields:
            from frob_interfaces.action import ExecuteMotion_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_ExecuteMotion_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'frob_interfaces.action.ExecuteMotion_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion_GetResult(metaclass=Metaclass_ExecuteMotion_GetResult):
    from frob_interfaces.action._execute_motion import ExecuteMotion_GetResult_Request as Request
    from frob_interfaces.action._execute_motion import ExecuteMotion_GetResult_Response as Response
    from frob_interfaces.action._execute_motion import ExecuteMotion_GetResult_Event as Event
...
class Metaclass_ExecuteMotion_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'frob_interfaces.action.ExecuteMotion_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion_FeedbackMessage(metaclass=Metaclass_ExecuteMotion_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'frob_interfaces/ExecuteMotion_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['frob_interfaces', 'action'], 'ExecuteMotion_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from frob_interfaces.action._execute_motion import ExecuteMotion_Feedback
...
class Metaclass_ExecuteMotion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'frob_interfaces.action.ExecuteMotion')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ExecuteMotion(metaclass=Metaclass_ExecuteMotion):
    ...
    from frob_interfaces.action._execute_motion import ExecuteMotion_Goal as Goal
    # The result message defined in the action definition.
    from frob_interfaces.action._execute_motion import ExecuteMotion_Result as Result
    # The feedback message defined in the action definition.
    from frob_interfaces.action._execute_motion import ExecuteMotion_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from frob_interfaces.action._execute_motion import ExecuteMotion_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from frob_interfaces.action._execute_motion import ExecuteMotion_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from frob_interfaces.action._execute_motion import ExecuteMotion_FeedbackMessage as FeedbackMessage
