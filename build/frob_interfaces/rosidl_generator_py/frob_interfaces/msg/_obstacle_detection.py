    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'frob_interfaces.msg.ObstacleDetection')
            logger.debug(
...
class ObstacleDetection(metaclass=Metaclass_ObstacleDetection):
    ...
    def __init__(self, **kwargs):
        ...
        self.zone_width = kwargs.get('zone_width', float())
    ...
    def __eq__(self, other):
        ...
        if self.distance != other.distance:
            return False
        if self.zone_width != other.zone_width:
            return False
        return True
    ...
    def zone_width(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'zone_width' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'zone_width' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
