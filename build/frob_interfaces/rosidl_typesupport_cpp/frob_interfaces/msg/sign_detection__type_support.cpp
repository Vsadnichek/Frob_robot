...
static const _SignDetection_type_support_symbol_names_t _SignDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frob_interfaces, msg, SignDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, frob_interfaces, msg, SignDetection)),
  }
};
...
{
  return &::frob_interfaces::msg::rosidl_typesupport_cpp::SignDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, frob_interfaces, msg, SignDetection)() {
  return get_message_type_support_handle<frob_interfaces::msg::SignDetection>();
}
