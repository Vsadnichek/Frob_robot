...
static const _ObstacleDetection_type_support_symbol_names_t _ObstacleDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, frob_interfaces, msg, ObstacleDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, frob_interfaces, msg, ObstacleDetection)),
  }
};
...
{
  return &::frob_interfaces::msg::rosidl_typesupport_cpp::ObstacleDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, frob_interfaces, msg, ObstacleDetection)() {
  return get_message_type_support_handle<frob_interfaces::msg::ObstacleDetection>();
}
