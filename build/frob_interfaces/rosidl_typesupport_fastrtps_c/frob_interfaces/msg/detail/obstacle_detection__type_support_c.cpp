...
#include "frob_interfaces/msg/detail/obstacle_detection__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleDetection__ros_msg_type = frob_interfaces__msg__ObstacleDetection;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = frob_interfaces__msg__ObstacleDetection;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const frob_interfaces__msg__ObstacleDetection * ros_message = static_cast<const frob_interfaces__msg__ObstacleDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_frob_interfaces__msg__ObstacleDetection(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  frob_interfaces__msg__ObstacleDetection * ros_message = static_cast<frob_interfaces__msg__ObstacleDetection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_frob_interfaces__msg__ObstacleDetection(cdr, ros_message);
}

static uint32_t _ObstacleDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_frob_interfaces__msg__ObstacleDetection(
...
static size_t _ObstacleDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_frob_interfaces__msg__ObstacleDetection(
